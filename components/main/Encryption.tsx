...
const Encryption = () => {
  return (
    <div className="pb-10 flex flex-row relative items-center justify-center min-h-screen w-full h-full">
        ...
        <div className="flex items-stretch justify-center">
          <div className="grid md:grid-cols-2">
            <div className="h-full pr-6">
              ...
              <div>
              <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3742.0250708233516!2d85.8631522752369!3d20.299229381173813!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMjDCsDE3JzU3LjIiTiA4NcKwNTEnNTYuNiJF!5e0!3m2!1sen!2sin!4v1716156031466!5m2!1sen!2sin"  ></iframe>
              </div>
              <ul className="mb-6 md:mb-0">
                <li className="flex">
                  ...
                  <div className="ml-4 mb-4">
                    ...
                    <p className="text-gray-600 dark:text-slate-400">Prachi Vihar, Palasuni
Rasulgarh</p>
                    <p className="text-gray-600 dark:text-slate-400"> Bhubaneswar
Odisha-751025</p>
                  </div>
                </li>
                <li className="flex">
