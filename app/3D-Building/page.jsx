  ...
  return (
    <div className="mt-10 pt-10 bg-white p-6 rounded-lg shadow-lg">
      <div className="bg-teal-500 text-white text-center py-2 rounded-t-lg">
        <h1 className="text-xl font-bold">PROJECT-3D Building</h1>
      </div>
      <div className="">
      <div className="flex flex-col md:flex-row px-4 py-2">
        <div className="flex-grow mb-4 md:mb-0">
          <div className="mb-4">
            ...
            A building footprint provides the outline of a building drawn alone the exterior walls, with a description of exact size, shape & location of its foundation.
            </p>
          </div>
          <div className="mb-4">
            <div className="flex items-center mb-2">
            ...
            <li className="text-gray-700  hover:bg-black hover:text-white  rounded-lg p-1">The roof prints of the building were capture using the Ortho photo.</li>
            <li className="text-gray-700  hover:bg-black hover:text-white  rounded-lg p-1">Experience of capturing large volume of data directly or vie remote access.</li>
            <li className="text-gray-700  hover:bg-black hover:text-white  rounded-lg p-1">Create ID of every building.</li>
            <li className="text-gray-700  hover:bg-black hover:text-white  rounded-lg p-1">Fill attribution.</li>
            <li className="text-gray-700  hover:bg-black hover:text-white  rounded-lg p-1">Shipment was made 3D shape file of building.</li>
